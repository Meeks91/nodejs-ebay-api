...
exports.parseResponseJson = function(data, requestContext, callback) {
  ...
  console.log('json-Parser: parseResponseJson() called')
  ...
  data = flatten(data, requestContext.parseDepth, requestContext);
    ...
    //console.log('json-Parser: parseResponseJson() called and data is: ', JSON.stringify(data.GetOrdersResponse.OrderArray[0].Order[0].TransactionArray))
